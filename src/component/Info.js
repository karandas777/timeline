  ...
  render() {
    return (
      <div className="container py-3">
        ...
        <div className="col-md-8 my-5 text-secondary form-bg mx-auto p-3 rounded">
            <div
              className="foot-logo text-dark pb-4"
            >
              Timeline Blogs
            </div>
          ...
          <div className="mt-4">
                  ...
                  <div className="my-3">
                        ...
                        <a className="text-decoration-none text-secondary" href="https://github.com/karandas777/timeline">Client (ReactJS)</a>
                  </div>
                  <div className="my-3">
                        <i className="fa fa-github fa-fw mr-2"></i>
                        <a className="text-decoration-none text-secondary" href="https://github.com/karandas777/timeline-server">Server (ExpressJS, MongoDB)</a>
                  </div>
          </div>
        </div>
      </div>
