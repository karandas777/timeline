...
import { funGetSortedPosts, funUpdatePost ,funDeletePost } from "../action/post.action";
...
export default connect(mapStateToProps, { funGetSortedPosts, funUpdatePost , funDeletePost})(
  User
);
